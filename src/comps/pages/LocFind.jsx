    ...
    return (
        <section className='LocFind' id='locFind'>
            ...
            <div className='Cardslgn'>
                <LocCard imgprop='./public/assets/LocNepImg.png' loc='Nepean' t1='LunVen    8h00 - 16h00' t2='SamDim 9h00 - 17h00' adr='33 Rue Lamagie, K1K 3F3' />
                <LocCard imgprop='./public/assets/LocOrlImg.png' loc='Orléans' t1='LunVen    8h00 - 16h00' t2='SamDim 10h00 - 17h00' adr='55 Operator Priv, K1K 5C5' />
            </div>
        </section>
    )
}
