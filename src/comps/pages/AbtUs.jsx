  ...
  return (
    <section className='AboutUs' id='abtus'>
      <div className='imgsfloat'>
        <img className='img1' src='./src/assets/Redreg.svg' alt="Red Decoration"/>
        <img className='img2' src='./src/assets/Regyota.png' alt="Toyota"/>
      </div>
      <div className='info'>
        ...
        <div className='txt'>
          <h2><img src='./src/assets/star.png' alt="Star"/><em>25+ ans d'expérience</em></h2>
        ...
        <div className='txt'>
          <h2><img src='./src/assets/ngrnj.svg' alt="Gear"/><em>Pièces de qualité</em></h2>
