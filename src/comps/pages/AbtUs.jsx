  ...
  return (
    <section className='AboutUs' id='abtus'>
      <div className='imgsfloat'>
        <img className='img1' src='./public/Redreg.svg' alt="Red Decoration"/>
        <img className='img2' src='./public/Regyota.png' alt="Toyota"/>
      </div>
      <div className='info'>
        ...
        <div className='txt'>
          <h2><img src='./public/star.png' alt="Star"/><em>25+ ans d'expérience</em></h2>
        ...
        <div className='txt'>
          <h2><img src='./public/ngrnj.svg' alt="Gear"/><em>Pièces de qualité</em></h2>
